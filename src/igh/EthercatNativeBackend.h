...
class MasterGuard {
public:
    explicit MasterGuard(std::mutex& mutex, ec_master_t*& cachedMaster, int& cachedMasterIndex, int index);
    ~MasterGuard();
...
public:
    ...
    QString upload(const QString& master, int position, const QString& index, const QString& subIndex,
                   const QString& type = QString(), QString* error = nullptr) const override;
    bool download(const QString& master, int position, const QString& index, const QString& subIndex,
                  const QString& value, const QString& type, QString* error = nullptr) const override;
