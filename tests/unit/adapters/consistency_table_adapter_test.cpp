...
void testCountsAndFirstRows() {
    ...
    expectEqual(firstConsistencyTableBlockingIssueRow(&table), 0, "first blocking row");
    expectEqual(firstConsistencyTableIoIssueRow(&table), 1, "first I/O issue row");
...
void testScopeAndSearchFiltering() {
    ...
    ConsistencyTableFilterStats stats =
        filterConsistencyTableRows(&table, QString::fromLatin1(kConsistencyScopeIo), QString());
    ...
    stats = filterConsistencyTableRows(&table, QString::fromLatin1(kConsistencyScopeWarning), "0x6060");
    ...
    stats = filterConsistencyTableRows(&table, QString::fromLatin1(kConsistencyScopeReady), QString());
