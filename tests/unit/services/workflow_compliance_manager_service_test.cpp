...
private slots:
    void testAddRule() {
        ...
        auto id =
            svc.addRule(QStringLiteral("IEC Compliance"), QStringLiteral("safety"), QStringLiteral("IEC 61508 SIL2"));
        QVERIFY(!id.isEmpty());
    ...
    void testRemoveRule() {
        WorkflowComplianceManagerService svc;
        auto id = svc.addRule(QStringLiteral("Test"), QStringLiteral("cat"), QStringLiteral("req"));
    ...
    void testGetRule() {
        WorkflowComplianceManagerService svc;
        auto id = svc.addRule(QStringLiteral("Quality Rule"), QStringLiteral("quality"), QStringLiteral("ISO 9001"));
        auto r = svc.rule(id);
