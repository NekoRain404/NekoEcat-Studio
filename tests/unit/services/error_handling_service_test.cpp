...
private slots:
    ...
    void testReportError() {
        ...
        int id = svc.reportError(0, 0x1234, "Test error", EcatErrorSeverity::Error, EcatErrorCategory::Communication);
        QVERIFY(id > 0);
    ...
    void testDetectErrors() {
        ErrorHandlingService svc;
        svc.reportError(0, 1, "info", EcatErrorSeverity::Info, EcatErrorCategory::Communication);
        svc.reportError(0, 2, "warning", EcatErrorSeverity::Warning, EcatErrorCategory::Device);
        svc.reportError(0, 3, "error", EcatErrorSeverity::Error, EcatErrorCategory::Network);
        svc.reportError(0, 4, "critical", EcatErrorSeverity::Critical, EcatErrorCategory::Protocol);
    ...
    void testRecoverFromError() {
        ...
        int id = svc.reportError(0, 1, "recoverable", EcatErrorSeverity::Error, EcatErrorCategory::Network);
    ...
    void testRecoverFromFatalFails() {
        ErrorHandlingService svc;
        int id = svc.reportError(0, 1, "fatal", EcatErrorSeverity::Critical, EcatErrorCategory::Protocol);
        auto errors = svc.errorHistory();
        QVERIFY(!svc.recoverFromError(errors[0]));
    }
    ...
    void testErrorHistory() {
        ErrorHandlingService svc;
        svc.reportError(0, 1, "first", EcatErrorSeverity::Error, EcatErrorCategory::Communication);
        svc.reportError(1, 2, "second", EcatErrorSeverity::Warning, EcatErrorCategory::Device);
    ...
    void testRecoveryAction() {
        ErrorHandlingService svc;
        svc.reportError(0, 1, "test", EcatErrorSeverity::Error, EcatErrorCategory::Configuration, "Reset device");
        auto h = svc.errorHistory();
    ...
    void testIdIncrement() {
        ErrorHandlingService svc;
        int id1 = svc.reportError(0, 1, "a", EcatErrorSeverity::Info, EcatErrorCategory::Communication);
        int id2 = svc.reportError(0, 2, "b", EcatErrorSeverity::Info, EcatErrorCategory::Communication);
        QVERIFY(id2 > id1);
    }
    ...
    void testMaxHistory() {
        ...
        for (int i = 0; i < 1100; ++i) {
            svc.reportError(0, i, "msg", EcatErrorSeverity::Info, EcatErrorCategory::Communication);
        }
