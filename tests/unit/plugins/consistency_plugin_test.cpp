...
private slots:
    ...
    void testUpdateConsistencyView() {
        ...
        rows << QStringList{"Error", "Topology", "#1 Slave1", "Baseline missing", "Online", "Missing", "Check cabling"};
        rows << QStringList{"Warning", "I/O", "#2 0x6000:01", "No value", "Evidence", "Missing", "Refresh Watch"};
        rows << QStringList{"Ready",      "Project",    "Current evidence", "No issues",
                            "Consistent", "Consistent", "Continue"};
