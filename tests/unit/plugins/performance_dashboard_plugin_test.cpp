...
private slots:
  ...
  void testPluginId() {
    QCOMPARE(plugin_->id(), QString("performancedashboard"));
  }

  void testDisplayName() {
    QCOMPARE(plugin_->displayName(), QString("Performance"));
  }

  void testDisplayNameZh() {
    QCOMPARE(plugin_->displayNameZh(), QString("性能监控"));
  }

  void testDefaultOrder() {
    QCOMPARE(plugin_->defaultOrder(), 135);
  }
