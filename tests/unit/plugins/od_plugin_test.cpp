...
private slots:
    ...
    void testUpdateSdoInspectorLabel() {
        ...
        QCOMPARE(p.sdoInspectorLabel()->text(), QString("Ready - Master localhost"));
    }
    ...
    void testUpdateSdoTargetTrailRowDetail() {
        ...
        QCOMPARE(p.sdoTargetTrailDetailLabel()->text(), QString("No selection"));
    }
    ...
    void testUpdateObjectBookmarkRowDetail() {
        ...
        QCOMPARE(p.objectBookmarkDetailLabel()->text(), QString("No selection"));
    }
    ...
    void testUpdateSdoTableEvidenceRow() {
        ...
        p.updateSdoTableEvidenceRow(0, "0x000F", "Complete", "12:00:00", QColor("#22c55e"), QColor("#eef2ff"));
