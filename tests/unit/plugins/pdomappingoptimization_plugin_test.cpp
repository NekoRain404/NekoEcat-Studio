...
void PdoMappingOptimizationPluginTest::testServiceOptimizeMapping() {
    ...
    QVERIFY(result.description.contains(QStringLiteral("backend"), Qt::CaseInsensitive));
...
void PdoMappingOptimizationPluginTest::testSourceDoesNotContainSyntheticOptimizationData() {
    QFile file(QStringLiteral(SOURCE_ROOT "/apps/ecat-studio/services/PdoMappingOptimizationService.cpp"));
