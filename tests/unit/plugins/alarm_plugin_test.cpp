...
private slots:
    ...
    void testAlarmRaisedPopulatesTable() {
        ...
        alarmSvc.raiseAlarm(AlarmLevel::Error, AlarmCategory::Communication, "Test alarm", "TestSource");
    ...
    void testMultipleAlarms() {
        ...
        alarmSvc.raiseAlarm(AlarmLevel::Info, AlarmCategory::Communication, "Info message");
        alarmSvc.raiseAlarm(AlarmLevel::Warning, AlarmCategory::Device, "Warning message");
        alarmSvc.raiseAlarm(AlarmLevel::Critical, AlarmCategory::Network, "Critical message");
    ...
    void testAlarmServiceSignals() {
        ...
        int id = alarmSvc.raiseAlarm(AlarmLevel::Error, AlarmCategory::Device, "Test");
    ...
    void testAlarmHistory() {
        ...
        for (int i = 0; i < 5; ++i) {
            alarmSvc.raiseAlarm(AlarmLevel::Info, AlarmCategory::Communication, QString("Msg %1").arg(i));
        }
    ...
    void testAlarmHistoryExportReportsPersistenceOutcome() {
        ...
        LoggingService logSvc;
        AlarmPlugin plugin(&alarmSvc, &logSvc);
        alarmSvc.raiseAlarm(AlarmLevel::Error, AlarmCategory::Communication, "Exported alarm", "AlarmTest");
