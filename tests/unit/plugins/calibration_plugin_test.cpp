...
private slots:
    ...
    void testHistory() {
        ...
        plugin.addHistoryEntry("Slave 0", CalibrationPlugin::CalibrationType::Full, 0.5, 1.002, 0.3);
        QCOMPARE(plugin.historyCount(), 1);

        plugin.addHistoryEntry("Slave 1", CalibrationPlugin::CalibrationType::Offset, 0.1, 1.0, 0.1);
    ...
    void testHistoryTable() {
        ...
        plugin.addHistoryEntry("Test", CalibrationPlugin::CalibrationType::Full, 0.0, 1.0, 0.0);
