// Unit tests for CommissioningWorkflowStepDetailUiState.
...
CommissioningWorkflowStepDetailTexts detailTexts() {
  return {
...
void testEmptyStates() {
  CommissioningWorkflowStepDetailUiState state =
      commissioningWorkflowStepDetailUnavailableState(detailTexts());
  ...
  state = commissioningWorkflowStepDetailNoSelectionState(detailTexts());
...
void testSeverityRules() {
  ...
  const CommissioningWorkflowStepDetailTexts detail = detailTexts();
  CommissioningWorkflowTableRow row = actionRow();
  expectEqual(commissioningWorkflowStepDetailSeverityKey(row, workflow, detail),
...
void testSelectedRowState() {
  const CommissioningWorkflowStepDetailUiState state =
      buildCommissioningWorkflowStepDetailUiState(actionRow(), workflowTexts(),
                                                  detailTexts());
...
void testLocalizedRiskAndNoRiskFallback() {
  ...
  workflow.blocked = "受阻";
  CommissioningWorkflowStepDetailUiState state =
      buildCommissioningWorkflowStepDetailUiState(row, workflow, detailTexts());
