...
void testEmptyState() {
  const HostHealthUiState state =
      buildHostHealthUiState(QJsonArray(), englishTexts());
...
void testRowsCountsSummaryAndColors() {
  ...
  const HostHealthUiState state =
      buildHostHealthUiState(checks, englishTexts());
...
void testWarningAndReadySummaries() {
  ...
  HostHealthUiState state =
      buildHostHealthUiState(warningChecks, englishTexts());
  ...
  state = buildHostHealthUiState(readyChecks, englishTexts());
