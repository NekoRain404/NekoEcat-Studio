...
void testSummaryAndSeverityRules() {
  ...
  expectEqual(slaveEvidenceSummaryGroupCount(input), 5,
              "ready evidence groups");
  expectEqual(slaveEvidenceSummarySeverityKey(input, 0), "ok",
              "ready severity");

  SlaveEvidenceSummaryDetail state =
      buildSlaveEvidenceSummaryDetail(input, 0, texts);
  ...
  expectEqual(slaveEvidenceSummarySeverityKey(input, 0), "warning",
