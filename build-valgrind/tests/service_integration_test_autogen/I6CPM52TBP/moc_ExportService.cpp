...
#include "../../../../apps/ecat-studio/services/ExportService.h"
...
void ExportService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->exportCompleted((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->exportFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ExportService::*)(const QString & )>(_a, &ExportService::exportCompleted, 0))
            return;
...
// SIGNAL 0
void ExportService::exportCompleted(const QString & _t1)
{
