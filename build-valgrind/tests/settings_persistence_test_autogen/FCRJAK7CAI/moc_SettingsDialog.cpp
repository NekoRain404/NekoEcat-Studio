...
#include "../../../../apps/ecat-studio/infra/SettingsDialog.h"
...
template <> constexpr inline auto SettingsDialog::qt_create_metaobjectdata<qt_meta_tag_ZN14SettingsDialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "SettingsDialog",
        "themePreviewRequested",
        "",
        "themeName"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'themePreviewRequested'
...
void SettingsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->themePreviewRequested((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SettingsDialog::*)(const QString & )>(_a, &SettingsDialog::themePreviewRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void SettingsDialog::themePreviewRequested(const QString & _t1)
{
