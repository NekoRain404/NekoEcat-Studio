...
#include "../../../../apps/ecat-studio/plugins/compliance/ComplianceCheckerPlugin.h"
...
void ComplianceCheckerPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->checkCompleted((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
        case 1: _t->rulesChanged(); break;
        case 2: _t->runCheck(); break;
        case 3: _t->addRule(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ComplianceCheckerPlugin::*)(double )>(_a, &ComplianceCheckerPlugin::checkCompleted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ComplianceCheckerPlugin::*)()>(_a, &ComplianceCheckerPlugin::rulesChanged, 1))
            return;
    }
}
...
// SIGNAL 0
void ComplianceCheckerPlugin::checkCompleted(double _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ComplianceCheckerPlugin::rulesChanged()
{
