...
QFrame* makeMetricCard(const QString& title, const QString& value, QLabel** valueLabel) {
...
QLabel* makeStatusSummaryLabel(const QString& text, const QString& tooltip, const QString& severity) {
    auto* label = new QLabel(text);
