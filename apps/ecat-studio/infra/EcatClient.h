...
public:
    ...
    void soeWrite(int position, const QString& idn, const QString& value, int drive = 0,
    ...
    void eoeConfigureIp(int position, const QString& ip, const QString& subnet, const QString& gateway = QString(),
...
signals:
    ...
    void redundancyCommandResult(const QString& command, bool success,
                                 const QString& message);  ///< Redundancy command result.
