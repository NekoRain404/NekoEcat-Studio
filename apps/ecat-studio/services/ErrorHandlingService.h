...
public:
    ...
    // @return Error ID
    int reportError(int position, int errorCode, const QString& message, EcatErrorSeverity severity,
                    EcatErrorCategory category, const QString& recoveryAction = QString());
