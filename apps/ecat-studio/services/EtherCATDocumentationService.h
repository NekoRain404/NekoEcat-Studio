...
class EtherCATDocumentationService : public QObject {
    Q_OBJECT
public:
    explicit EtherCATDocumentationService(EventBus* bus, EcatClient* client, QObject* parent = nullptr);
...
private:
    Documentation makeDoc(const QString& title, const QString& content, const QVector<DocSection>& sections,
