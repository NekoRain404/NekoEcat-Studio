...
class EtherCATAnalyticsService : public QObject {
    Q_OBJECT
public:
    explicit EtherCATAnalyticsService(EventBus* bus, EcatClient* client, QObject* parent = nullptr);
...
private:
    AnalysisResult makeResult(const QString& category, const QString& summary, const QVector<QString>& trends,
                              const QVector<QString>& patterns, const QVector<QString>& anomalies,
