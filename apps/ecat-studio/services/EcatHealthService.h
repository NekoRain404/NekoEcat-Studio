...
public:
    ...
    explicit EcatHealthService(EcatClient* client, EventBus* bus, TopologyService* topology, DcSyncService* dcSync,
                               AlEventService* alEvent, WatchdogService* watchdog, QObject* parent = nullptr);
