...
public:
    ...
    void cacheValue(int position, const QString& index, const QString& subIndex, const QString& value);
    ...
    QString getCachedValue(int position, const QString& index, const QString& subIndex) const;
