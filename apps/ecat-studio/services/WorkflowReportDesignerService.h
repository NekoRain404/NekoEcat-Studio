...
public:
    ...
    QString createTemplate(const QString& name, const QString& description, const QStringList& sections,
                           const QStringList& dataFields);
    bool removeTemplate(const QString& templateId);
    bool updateTemplate(const QString& templateId, const QString& name, const QStringList& sections);
    ...
    WfCustomReport generateReport(const QString& templateId, const QJsonObject& data);
...
private:
    static bool isValidTemplateDefinition(const QString& name, const QStringList& sections);
