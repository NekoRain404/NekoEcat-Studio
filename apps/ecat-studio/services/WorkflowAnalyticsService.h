...
public:
  ...
  void recordExecution(const QString &workflowId, bool success,
                       double durationMs, const QJsonObject &details = {});
  void recordError(const QString &workflowId, const QString &errorType,
                   const QString &message);
  void recordResourceUsage(const QString &workflowId, double cpuPercent,
                           double memoryMb, double networkKbps);
