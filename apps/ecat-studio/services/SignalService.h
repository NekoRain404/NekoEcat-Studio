...
public:
    ...
    int addChannel(const QString& name, int slave, const QString& idx, const QString& sub);
    ...
    void pushData(int channelId, const QVector<double>& values, const QVector<qint64>& timestamps);
...
private slots:
    ...
    void handleSignalData(int channel, const QVector<double>& values, const QVector<qint64>& timestamps);
