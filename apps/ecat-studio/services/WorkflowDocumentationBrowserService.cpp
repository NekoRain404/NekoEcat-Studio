...
WorkflowDocumentationBrowserService::WorkflowDocumentationBrowserService(QObject* parent) : QObject(parent) {}

QString WorkflowDocumentationBrowserService::addNode(const QString& parentId, const QString& title,
...
QVector<WfDocNode> WorkflowDocumentationBrowserService::childNodes(const QString& parentId) const {
...
QVector<WfDocSearchResult> WorkflowDocumentationBrowserService::search(const QString& query) {
...
QString WorkflowDocumentationBrowserService::addBookmark(const QString& nodeId, const QString& title,
                                                         const QString& note) {
