...
public:
    ...
    AllocationPlan optimizeResourceAllocation(const QVector<WfResource>& resources, const QVector<WfTask>& tasks);
...
private:
    void emitResult(const QString& category, const QString& description, double improvement,
