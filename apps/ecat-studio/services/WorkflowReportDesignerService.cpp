...
WorkflowReportDesignerService::WorkflowReportDesignerService(QObject* parent) : QObject(parent) {}

bool WorkflowReportDesignerService::isValidTemplateDefinition(const QString& name, const QStringList& sections) {
    if (name.trimmed().isEmpty() || sections.isEmpty())
        return false;
...
QString WorkflowReportDesignerService::createTemplate(const QString& name, const QString& description,
...
bool WorkflowReportDesignerService::updateTemplate(const QString& templateId, const QString& name,
...
WfCustomReport WorkflowReportDesignerService::generateReport(const QString& templateId, const QJsonObject& data) {
