...
private:
  ...
  void addFlowchartNode(QGraphicsScene *scene, const QString &id,
                        const QString &label, double x, double y);
  void addFlowchartEdge(QGraphicsScene *scene, double x1, double y1,
                        double x2, double y2);
  void addGanttBar(QGraphicsScene *scene, const WfGanttEntry &entry, int row);
  void addGraphNode(QGraphicsScene *scene, const QString &id, double x,
                    double y, const QColor &color);
  void addGraphEdge(QGraphicsScene *scene, double x1, double y1, double x2,
                    double y2);
  void addTimelineRow(QGraphicsScene *scene, const WfVizResource &resource,
