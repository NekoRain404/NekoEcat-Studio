...
public:
    ...
    explicit AsyncOperationManager(int maxConcurrent = kMaxConcurrent, QObject* parent = nullptr);
    ...
    QString execute(const QString& name, OperationFunc func, OperationPriority priority = OperationPriority::Normal,
                    int timeoutMs = 30000);
