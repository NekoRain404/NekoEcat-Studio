...
ReportGeneratorService::ReportGeneratorService(QObject *parent)
    : QObject(parent) {}
...
void ReportGeneratorService::addSection(const QString &heading,
...
bool ReportGeneratorService::exportReport(const QString &path,
...
void ReportGeneratorService::clearSections() { sections_.clear(); }
