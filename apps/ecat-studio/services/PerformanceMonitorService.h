...
public:
    ...
    explicit PerformanceMonitorService(EventBus* bus, EcatClient* client, QObject* parent = nullptr);
...
signals:
    ...
    void performanceAlert(const QString& category, const QString& message, double value, double threshold);
