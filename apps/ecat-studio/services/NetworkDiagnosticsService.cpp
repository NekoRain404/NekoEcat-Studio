...
NetworkDiagnosticsService::NetworkDiagnosticsService(EcatClient* client, QObject* parent)
...
void NetworkDiagnosticsService::stopMonitoring() {
    pollTimer_->stop();
}
