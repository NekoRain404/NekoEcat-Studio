...
public:
    ...
    QString addNode(const QString& parentId, const QString& title, const QString& content);
    ...
    QString addBookmark(const QString& nodeId, const QString& title, const QString& note = {});
