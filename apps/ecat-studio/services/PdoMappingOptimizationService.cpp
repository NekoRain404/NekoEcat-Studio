...
PdoMappingOptimizationService::PdoMappingOptimizationService(QObject* parent) : QObject(parent) {}

PdoMappingOptimizationResult PdoMappingOptimizationService::createRejectedResult(const QString& category,
                                                                                 const QStringList& recommendations) {
    PdoMappingOptimizationResult r;
    r.category = category;
    r.description = tr("%1 optimization requires a connected PDO mapping backend").arg(category);
