...
WorkflowVisualizationStudioService::WorkflowVisualizationStudioService(QObject *parent)
    : QObject(parent) {}

QString WorkflowVisualizationStudioService::createProject(const QString &name,
...
QString WorkflowVisualizationStudioService::addScene(const QString &projectId,
                                                      const QString &name) {
...
QVector<WfStudioScene> WorkflowVisualizationStudioService::scenesForProject(
