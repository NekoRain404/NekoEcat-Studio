...
OverviewPlugin::OverviewPlugin(ServiceContainer *container, QObject *parent)
...
// ── Identity ──────────────────────────────────────────────────────────
QString OverviewPlugin::id() const { return "overview"; }
QString OverviewPlugin::displayName() const { return "Overview"; }
QString OverviewPlugin::displayNameZh() const { return QStringLiteral("总览"); }
QIcon OverviewPlugin::icon() const { return QIcon::fromTheme("view-list-details"); }
int OverviewPlugin::defaultOrder() const { return 5; }
bool OverviewPlugin::visible() const { return true; }
...
QWidget *OverviewPlugin::widget() { return containerWidget_; }

// ── Sub-tab accessors ─────────────────────────────────────────────────
QTabWidget *OverviewPlugin::overviewTabs() const { return tabs_; }
int OverviewPlugin::detailsTabIndex() const { return 0; }
int OverviewPlugin::briefTabIndex() const { return 1; }
int OverviewPlugin::workflowTabIndex() const { return 2; }
int OverviewPlugin::matrixTabIndex() const { return 3; }

// ── Table accessors ───────────────────────────────────────────────────
QTableWidget *OverviewPlugin::metricTable() const { return metricTable_; }
QTableWidget *OverviewPlugin::identityTable() const { return identityTable_; }
QTableWidget *OverviewPlugin::portTable() const { return portTable_; }
QTableWidget *OverviewPlugin::mailboxTable() const { return mailboxTable_; }
QTableWidget *OverviewPlugin::sessionBriefTable() const {
  return sessionBriefTable_;
}
QTableWidget *OverviewPlugin::workflowTable() const { return workflowTable_; }
