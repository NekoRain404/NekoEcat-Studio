...
QString MaintenanceSchedulerPlugin::id() const {
    return "maintenancescheduler";
}
QString MaintenanceSchedulerPlugin::displayName() const {
    return "Maintenance Scheduler";
}
QString MaintenanceSchedulerPlugin::displayNameZh() const {
    return QStringLiteral("维护调度器");
}
QIcon MaintenanceSchedulerPlugin::icon() const {
    return QIcon::fromTheme("preferences-system-time");
}
int MaintenanceSchedulerPlugin::defaultOrder() const {
    return 320;
}
bool MaintenanceSchedulerPlugin::visible() const {
    return false;
}
void MaintenanceSchedulerPlugin::activate() {}
void MaintenanceSchedulerPlugin::deactivate() {}

QWidget* MaintenanceSchedulerPlugin::widget() {
    return container_;
}
QTableWidget* MaintenanceSchedulerPlugin::taskTable() const {
    return taskTable_;
}
QTableWidget* MaintenanceSchedulerPlugin::scheduleTable() const {
    return scheduleTable_;
}
QTableWidget* MaintenanceSchedulerPlugin::historyTable() const {
    return historyTable_;
}
QTextEdit* MaintenanceSchedulerPlugin::reportPanel() const {
    return reportPanel_;
}
QLabel* MaintenanceSchedulerPlugin::statusLabel() const {
    return statusLabel_;
}

int MaintenanceSchedulerPlugin::taskCount() const {
    return tasks_.size();
}
int MaintenanceSchedulerPlugin::scheduleCount() const {
    return scheduleTable_ ? scheduleTable_->rowCount() : 0;
}
int MaintenanceSchedulerPlugin::historyCount() const {
...
void MaintenanceSchedulerPlugin::buildUi() {
    ...
    taskTable_->setHorizontalHeaderLabels(
        {tr("Name"), tr("Description"), tr("Schedule"), tr("Priority"), tr("Status")});
...
void MaintenanceSchedulerPlugin::removeScheduleEntry(int index) {
    if (index < 0 || index >= scheduleTable_->rowCount())
        return;
