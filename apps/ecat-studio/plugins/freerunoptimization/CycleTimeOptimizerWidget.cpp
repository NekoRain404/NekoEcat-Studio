...
CycleTimeOptimizerWidget::CycleTimeOptimizerWidget(QWidget* parent) : QWidget(parent) {
    buildUi();
}
...
void CycleTimeOptimizerWidget::buildUi() {
    ...
    connect(optimizeBtn_, &QPushButton::clicked, this, &CycleTimeOptimizerWidget::optimizeRequested);
}

void CycleTimeOptimizerWidget::updateCurrentCycleTime(double cycleTimeUs, double jitterUs) {
