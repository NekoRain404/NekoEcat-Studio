...
DataMappingOptimizerWidget::DataMappingOptimizerWidget(QWidget *parent)
    : QWidget(parent) {
  buildUi();
}
...
void DataMappingOptimizerWidget::buildUi() {
  ...
  connect(optimizeBtn_, &QPushButton::clicked,
          this, &DataMappingOptimizerWidget::optimizeRequested);
}

void DataMappingOptimizerWidget::updateCurrentMapping(int totalBytes,
                                                      int entries,
                                                      int unusedBytes) {
