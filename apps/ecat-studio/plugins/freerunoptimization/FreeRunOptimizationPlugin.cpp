...
FreeRunOptimizationPlugin::FreeRunOptimizationPlugin(EcatClient* client, EventBus* bus, QObject* parent) {
    if (parent)
        setParent(parent);
    ...
    connect(service_, &FreeRunOptimizationService::optimizationCompleted, this,
            &FreeRunOptimizationPlugin::handleOptimizationCompleted);
    connect(service_, &FreeRunOptimizationService::optimizationApplied, this,
            &FreeRunOptimizationPlugin::handleOptimizationApplied);
}
...
int FreeRunOptimizationPlugin::defaultOrder() const {
    return 44;
}
bool FreeRunOptimizationPlugin::visible() const {
    return false;
}
QWidget* FreeRunOptimizationPlugin::widget() {
...
void FreeRunOptimizationPlugin::buildUi() {
    ...
    connect(exportBtn_, &QPushButton::clicked, this, &FreeRunOptimizationPlugin::handleExport);
}
...
QWidget* FreeRunOptimizationPlugin::buildCycleTimeTab() {
    ...
    connect(cycleTimeWidget_, &CycleTimeOptimizerWidget::optimizeRequested, this,
            &FreeRunOptimizationPlugin::handleCycleTimeOptimize);
...
QWidget* FreeRunOptimizationPlugin::buildDataMappingTab() {
    ...
    connect(dataMappingWidget_, &DataMappingOptimizerWidget::optimizeRequested, this,
            &FreeRunOptimizationPlugin::handleDataMappingOptimize);
...
QWidget* FreeRunOptimizationPlugin::buildPerformanceTab() {
    ...
    connect(perfOptimizeBtn_, &QPushButton::clicked, this, &FreeRunOptimizationPlugin::handlePerformanceOptimize);
...
QWidget* FreeRunOptimizationPlugin::buildErrorHandlerTab() {
    ...
    connect(errorOptimizeBtn_, &QPushButton::clicked, this, &FreeRunOptimizationPlugin::handleErrorHandlingOptimize);
...
void FreeRunOptimizationPlugin::handleExport() {
    const QString path = QFileDialog::getSaveFileName(containerWidget_, tr("Export Free Run Optimization Report"),
