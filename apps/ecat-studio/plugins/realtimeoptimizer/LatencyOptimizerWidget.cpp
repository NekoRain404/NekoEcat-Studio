...
LatencyOptimizerWidget::LatencyOptimizerWidget(QWidget* parent) : QWidget(parent) {
    buildUi();
}
...
void LatencyOptimizerWidget::buildUi() {
    ...
    currentLatencyLabel_->setStyleSheet("color: #cccccc; font-weight: bold; font-size: 24px;");
    ...
    optimizedLatencyLabel_->setStyleSheet("color: #22c55e; font-size: 18px;");
    ...
    connect(optimizeBtn_, &QPushButton::clicked, this, &LatencyOptimizerWidget::optimizeRequested);
