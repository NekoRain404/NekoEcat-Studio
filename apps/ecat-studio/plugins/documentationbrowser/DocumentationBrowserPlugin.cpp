...
QString DocumentationBrowserPlugin::id() const { return "documentationbrowser"; }
QString DocumentationBrowserPlugin::displayName() const { return "Documentation Browser"; }
...
QWidget *DocumentationBrowserPlugin::widget() { return containerWidget_; }
QTreeWidget *DocumentationBrowserPlugin::docTree() const { return docTree_; }
QTextEdit *DocumentationBrowserPlugin::contentViewer() const { return contentViewer_; }
QLineEdit *DocumentationBrowserPlugin::searchBox() const { return searchBox_; }
QListWidget *DocumentationBrowserPlugin::bookmarks() const { return bookmarks_; }
...
void DocumentationBrowserPlugin::clearDocuments() { docTree_->clear(); }
...
void DocumentationBrowserPlugin::addBookmark(const QString &title) {
  for (int i = 0; i < bookmarks_->count(); ++i) {
    if (bookmarks_->item(i)->text() == title) return;
  }
...
void DocumentationBrowserPlugin::clearBookmarks() { bookmarks_->clear(); }
int DocumentationBrowserPlugin::bookmarkCount() const { return bookmarks_->count(); }
