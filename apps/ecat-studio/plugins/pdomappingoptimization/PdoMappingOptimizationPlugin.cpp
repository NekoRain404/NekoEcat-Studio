...
PdoMappingOptimizationPlugin::PdoMappingOptimizationPlugin(QObject* parent) {
    ...
    connect(service_, &PdoMappingOptimizationService::optimizationCompleted, this,
            &PdoMappingOptimizationPlugin::handleOptimizationCompleted);
    connect(service_, &PdoMappingOptimizationService::optimizationApplied, this,
            &PdoMappingOptimizationPlugin::handleOptimizationApplied);
}
...
int PdoMappingOptimizationPlugin::defaultOrder() const {
    return 46;
}
bool PdoMappingOptimizationPlugin::visible() const {
    return false;
}
QWidget* PdoMappingOptimizationPlugin::widget() {
...
void PdoMappingOptimizationPlugin::buildUi() {
    ...
    connect(exportBtn_, &QPushButton::clicked, this, &PdoMappingOptimizationPlugin::handleExport);
}
...
QWidget* PdoMappingOptimizationPlugin::buildMappingTab() {
    ...
    connect(mappingWidget_, &MappingOptimizerWidget::optimizeRequested, this,
            &PdoMappingOptimizationPlugin::handleMappingOptimize);
...
QWidget* PdoMappingOptimizationPlugin::buildSizeTab() {
    ...
    connect(sizeWidget_, &SizeOptimizerWidget::optimizeRequested, this,
            &PdoMappingOptimizationPlugin::handleSizeOptimize);
...
QWidget* PdoMappingOptimizationPlugin::buildAlignmentTab() {
    ...
    connect(alignOptimizeBtn_, &QPushButton::clicked, this, &PdoMappingOptimizationPlugin::handleAlignmentOptimize);
...
QWidget* PdoMappingOptimizationPlugin::buildPerformanceTab() {
    ...
    connect(perfOptimizeBtn_, &QPushButton::clicked, this, &PdoMappingOptimizationPlugin::handlePerformanceOptimize);
...
void PdoMappingOptimizationPlugin::handleExport() {
    const QString path = QFileDialog::getSaveFileName(containerWidget_, tr("Export PDO Mapping Optimization Report"),
