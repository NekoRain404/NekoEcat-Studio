...
SizeOptimizerWidget::SizeOptimizerWidget(QWidget* parent) : QWidget(parent) {
    buildUi();
}
...
void SizeOptimizerWidget::buildUi() {
    ...
    connect(optimizeBtn_, &QPushButton::clicked, this, &SizeOptimizerWidget::optimizeRequested);
}

void SizeOptimizerWidget::updateCurrentSize(int totalBytes, int inputBytes, int outputBytes, int wastedBytes) {
