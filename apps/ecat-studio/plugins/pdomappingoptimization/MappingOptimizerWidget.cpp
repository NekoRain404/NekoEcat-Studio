...
MappingOptimizerWidget::MappingOptimizerWidget(QWidget *parent)
    : QWidget(parent) {
  buildUi();
}
...
void MappingOptimizerWidget::buildUi() {
  ...
  connect(optimizeBtn_, &QPushButton::clicked,
          this, &MappingOptimizerWidget::optimizeRequested);
}

void MappingOptimizerWidget::updateCurrentMapping(int totalPdos, int totalEntries,
                                                   int duplicateEntries, int unusedEntries) {
