...
class WorkflowOptimizerPlugin : public WorkspacePlugin {
  Q_OBJECT
public:
  explicit WorkflowOptimizerPlugin(WorkflowAnalyticsService *analytics,
  ...
  void addSuggestion(const QString &workflowId, const QString &priority,
                     const QString &suggestion);
  int suggestionCount() const;

  void addExecutionRecord(const QString &workflowId, const QString &status,
                          double durationMs);
