...
class WorkflowDashboardPlugin : public WorkspacePlugin {
    Q_OBJECT
public:
    explicit WorkflowDashboardPlugin(WorkflowMonitoringService* monitoring, QObject* parent = nullptr);
    ...
    void addActiveWorkflow(const QString& workflowId, const QString& name, const QString& status);
    ...
    void addAlert(const QString& severity, const QString& source, const QString& message);
