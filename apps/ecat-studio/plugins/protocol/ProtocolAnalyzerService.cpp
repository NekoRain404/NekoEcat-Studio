...
ProtocolAnalyzerService::ProtocolAnalyzerService(QObject* parent) : QObject(parent) {}
...
bool ProtocolAnalyzerService::isCapturing() const {
    return capturing_;
}
...
ProtocolFilter ProtocolAnalyzerService::filter() const {
    return filter_;
}
...
int ProtocolAnalyzerService::frameCount() const {
    return frames_.size();
}

ProtocolStatistics ProtocolAnalyzerService::statistics() const {
    return stats_;
}
