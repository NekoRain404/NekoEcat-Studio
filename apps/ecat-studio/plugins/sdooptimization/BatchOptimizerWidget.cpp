...
BatchOptimizerWidget::BatchOptimizerWidget(QWidget* parent) : QWidget(parent) {
    buildUi();
}
...
void BatchOptimizerWidget::buildUi() {
    ...
    connect(optimizeBtn_, &QPushButton::clicked, this, &BatchOptimizerWidget::optimizeRequested);
}

void BatchOptimizerWidget::updateCurrentBatch(int batchSize, double transferTime, double overhead) {
