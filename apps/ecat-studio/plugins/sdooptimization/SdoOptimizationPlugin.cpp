...
SdoOptimizationPlugin::SdoOptimizationPlugin(EcatClient *client,
                                             EventBus *bus,
                                             QObject *parent) {
  ...
  connect(service_, &SdoOptimizationService::optimizationCompleted,
          this, &SdoOptimizationPlugin::handleOptimizationCompleted);
  connect(service_, &SdoOptimizationService::optimizationApplied,
          this, &SdoOptimizationPlugin::handleOptimizationApplied);
}
...
void SdoOptimizationPlugin::buildUi() {
  ...
  connect(exportBtn_, &QPushButton::clicked,
          this, &SdoOptimizationPlugin::handleExport);
}
...
QWidget *SdoOptimizationPlugin::buildCacheTab() {
  ...
  connect(cacheWidget_, &CacheOptimizerWidget::optimizeRequested,
          this, &SdoOptimizationPlugin::handleCacheOptimize);
...
QWidget *SdoOptimizationPlugin::buildBatchTab() {
  ...
  connect(batchWidget_, &BatchOptimizerWidget::optimizeRequested,
          this, &SdoOptimizationPlugin::handleBatchOptimize);
...
QWidget *SdoOptimizationPlugin::buildPerformanceTab() {
  ...
  connect(perfOptimizeBtn_, &QPushButton::clicked,
          this, &SdoOptimizationPlugin::handlePerformanceOptimize);
...
QWidget *SdoOptimizationPlugin::buildErrorHandlerTab() {
  ...
  connect(errorOptimizeBtn_, &QPushButton::clicked,
          this, &SdoOptimizationPlugin::handleErrorHandlingOptimize);
...
void SdoOptimizationPlugin::handleExport() {
  const QString path = QFileDialog::getSaveFileName(
      containerWidget_, tr("Export SDO Optimization Report"), QString(),
