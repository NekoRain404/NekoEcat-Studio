...
CacheOptimizerWidget::CacheOptimizerWidget(QWidget *parent)
    : QWidget(parent) {
  buildUi();
}
...
void CacheOptimizerWidget::buildUi() {
  ...
  connect(optimizeBtn_, &QPushButton::clicked,
          this, &CacheOptimizerWidget::optimizeRequested);
}

void CacheOptimizerWidget::updateCurrentCache(int size, double hitRate,
                                              double missLatency) {
