...
QString DashboardDesignerPlugin::id() const {
    return "dashboarddesigner";
}
QString DashboardDesignerPlugin::displayName() const {
    return "Dashboard Designer";
}
QString DashboardDesignerPlugin::displayNameZh() const {
    return "仪表盘设计器";
}
int DashboardDesignerPlugin::defaultOrder() const {
    return 235;
}
bool DashboardDesignerPlugin::visible() const {
    return false;
}
...
int DashboardDesignerPlugin::widgetCount() const {
    return widgets_.size();
}

int DashboardDesignerPlugin::selectedWidget() const {
...
void DashboardDesignerPlugin::setPreviewMode(bool preview) {
    ...
    if (modeTabs_)
        modeTabs_->setCurrentIndex(preview ? 1 : 0);
}

bool DashboardDesignerPlugin::isPreviewMode() const {
    return previewMode_;
}

QListWidget* DashboardDesignerPlugin::widgetPalette() const {
    return widgetPalette_;
}
QTableWidget* DashboardDesignerPlugin::propertyEditor() const {
    return propertyEditor_;
}
QTabWidget* DashboardDesignerPlugin::modeTabs() const {
    return modeTabs_;
}
QLabel* DashboardDesignerPlugin::statusLabel() const {
    return statusLabel_;
}
