...
DeviceVerificationWidget::DeviceVerificationWidget(HardwareVerificationService* service, QWidget* parent)
    ...
    connect(runButton_, &QPushButton::clicked, this, &DeviceVerificationWidget::runVerification);
}
...
void DeviceVerificationWidget::displayResult(const VerificationResult& result) {
