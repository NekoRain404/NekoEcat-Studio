...
bool commissioningWorkflowNoneText(
    const QString &text, const WorkflowStepDetailTexts &texts) {
...
WorkflowStepDetailState
workflowStepDetailUnavailableState(
...
WorkflowStepDetailState
workflowStepDetailNoSelectionState(
    const WorkflowStepDetailTexts &texts) {
...
QString workflowStepDetailSeverityKey(
    const CommissioningWorkflowTableRow &row,
...
buildWorkflowStepDetailState(
  ...
  state.severityKey =
      workflowStepDetailSeverityKey(row, workflowTexts, texts);
