...
void setBoundary(WorkspaceBoundaryDetail* state, const QString& label, const QString& severity,
...
WorkspaceBoundaryDetail buildWorkspaceBoundaryDetail(WorkspaceBoundaryKind kind, const QString& workspaceName,
    ...
    switch (kind) {
        ...
        case WorkspaceBoundaryKind::ObjectDictionary:
            setBoundary(&state, texts.objectDictionaryLabel, QStringLiteral("warning"),
        ...
        case WorkspaceBoundaryKind::Notes:
            setBoundary(&state, texts.notesLabel, QStringLiteral("neutral"), {texts.notesLocalRecords});
            break;
        case WorkspaceBoundaryKind::RawEvidence:
            setBoundary(&state, texts.rawEvidenceLabel, QStringLiteral("neutral"), {texts.rawEvidenceCachedOutput});
            break;
    }
