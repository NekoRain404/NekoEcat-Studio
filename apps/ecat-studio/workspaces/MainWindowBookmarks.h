...
void addDictionaryRowsToBookmarks(const QVector<int>& rows, const QString& sourceLabel);
void addObjectBookmark(int position, const QString& index, const QString& subIndex, const QString& access,
                       const QString& type, const QString& bits, const QString& name, const QString& lastValue,
